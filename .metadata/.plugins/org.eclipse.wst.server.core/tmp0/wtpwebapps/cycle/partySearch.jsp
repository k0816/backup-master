...
/*---カレンダー機能---*/
    $(function() {
   	 $("#date1").datepicker("option", "dateFormat", "yyyy/mm/dd");
    	 $("#date1").datepicker("setDate", "2018/01/26");
    	  $("#date1").datepicker( {
    	    changeMonth: true,
    	    numberOfMonths: 2,
    	  } );
...
<!--	<s:property value="dateUtil.getDateDay()" /> -->
...
<s:form id="form" name="form" action="PartySearchResultAction">
   ...
   開催日：<input type="text" id="date1" name="partyDate">～<input type="text" id="date2" name="date2" /><br>
  曜日：
